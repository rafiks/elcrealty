          ...
          </p>
          {
            formData.imageUrls.length > 0 && formData.imageUrls.map((url, index) => (
              <div key={url} className="flex justify-between p-3 border items-center">
                ...
                <button onClick={() => handleRemoveImage(index)} className="p-3 text-red-700 rounded-lg uppercase hover:opacity-75 " type='button'>Delete</button>
              </div>
            ))
          }
          <button disabled={loading || uploading} className='p-3 uppercase rounded-lg hover:shadow-lg disabled:opacity-80 bg-slate-700 text-white'>
